...
final class CoursesGetController extends Controller
{
    public const ALL_COURSES = [
        77070 => [
            ...
            'price_plan_id' => '4c5be45d-799b-49c5-93bc-859a832a2a65',
        ],
        66748 => [
            'id'            => '66748',
        ...
        87157 => [
            ...
            'authors'       => ['b4b9ee99-8290-4064-8e3c-e4fd925fe0b9', '39402ea6-d5a0-4466-918d-e5eef75cc8a9'],
            'price_plan_id' => 'f1f62b61-e123-434f-99ff-4c64d7f34f3b',
        ],
    ];

    public function handle(array $request): string
    {
        return $this->hasResourceId($request)
            ? $this->specificCourse($this->resourceId($request))
            : $this->jsonResponse(array_values(self::ALL_COURSES));
    }

    public function specificCourse(string $courseId): string
    {
        return isset(self::ALL_COURSES[$courseId])
            ? $this->jsonResponse(self::ALL_COURSES[$courseId])
            : $this->notFoundResponse("The course `$courseId` doesn't exist");
    }
}
